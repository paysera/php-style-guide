...
1. [PHP basics](https://github.com/paysera/php-style-guide/tree/master/php-basics)
1. [Main patterns](https://github.com/paysera/php-style-guide/tree/master/main-patterns)
